...
キーワード「${keyword}」を自然な文脈で3〜5回使用してください。
`;

  console.log('📝 記事本文を生成中...\n');
...
if (require.main === module) {
  console.log('🚀 人間らしい文章のサンプルブログ記事を生成します\n');
  ...
  generateSampleBlogPost()
    .then(post => {
      ...
      console.log('\n' + '='.repeat(60));
      console.log(`📏 文字数: ${post.content.length} 文字`);
    })
    .catch(error => {
